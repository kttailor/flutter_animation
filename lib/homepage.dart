                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    PageView(
                      ...
                      children: <Widget>[LeopardPage(), ValturePage()],
                    ),
                    AppBar(),
                    LeopardImage(),
                    VultureImage(),
      ...
      child: RotatedBox(
          ...
          child: SizedBox(
            ...
            child: FittedBox(
              ...
              fit: BoxFit.cover,
              child: Text('72', style: TextStyle(fontWeight: FontWeight.bold)),
            ),
          )),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: Consumer<PageOffsetNotifier>(
        ...
        child: FlatButton(
          child: Text('ON MAP', style: TextStyle(fontSize: 12)),
          onPressed: () {
              ...
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      border: Border.all(color: Color(0xFFFFFFFF), width: 2.5),
...
class ValturePage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Center(
